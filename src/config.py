"""Các hằng cấu hình và bộ dựng pipeline cho phần đánh giá CoT."""
import os
...
def build_pipeline():
    ...
    # Tokenizer kiểu Llama thường không định nghĩa pad token sẵn.
    # Sinh theo batch cần một pad token, nên dùng lại EOS và pad trái đầu vào.
