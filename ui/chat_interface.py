...
def render_chat_interface(engine):
    ...
    """
    # TODO[2]: Hiển thị tiêu đề "Xây dựng chatbot cơ bản" bằng st.title()
    
    # TODO[2]: Khởi tạo chat_history trong session_state nếu chưa có
    # st.session_state.chat_history = []
    
    # TODO[2]: Hiển thị lịch sử chat
    ...
    # TODO[2]: Tạo chat input box bằng st.chat_input()
    # Placeholder: "Nhập tin nhắn của bạn ở đây..."
    
    # TODO[2]: Xử lý khi user gửi tin nhắn
    # if user_input:
