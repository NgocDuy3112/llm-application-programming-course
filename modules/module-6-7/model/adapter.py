...
class GroqAdapter(BaseAdapter):
    ...
    def _initialize_client(self):
        ...
        global_logger.debug("Khởi tạo Groq client")
        if not api_key:
            global_logger.error("GROQ_API_KEY không tìm thấy trong environment")
...
class OllamaAdapter(BaseAdapter):
    ...
    def _initialize_client(self):
        ...
        """
        global_logger.debug("Khởi tạo Ollama client tại http://localhost:11434/v1/")
        return OpenAI(
